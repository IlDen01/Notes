...
\begin{document}
	...
	\begin{enumerate}
		...
		$\dint \dfrac{dx}{x^2 + a^2} = \dfrac{1}{a^2} \dint \dfrac{a d \left( \dfrac{x}{a} \right)}{\left( \dfrac{x}{a} \right)^2 + 1} = \dfrac{1}{a} \arctg \dfrac{x}{a} + C$
		
		\item $\dint \dfrac{dx}{x^2 - a^2} = \dfrac{1}{2 a} \left( \dint \dfrac{d (x - a)}{x - 1} - \dint \dfrac{d (x + a)}{x + a} \right) = \dfrac{1}{2 a} \left( \ln |x - a| - \ln |x + a| \right) + C = \dfrac{1}{2 a} \ln \left| \dfrac{x - a}{x + a} \right| + C$
		\item $\dint \dfrac{dx}{\sqrt{1 - x^2}} = \arcsin x + C$
		\item $\dint \dfrac{dx}{\sqrt{x^2 - 1}} = \arcsinh x + C$
		\item $\dint \dfrac{dx}{\sqrt{x^2 + 1}} = \ln \left( x + \sqrt{x^2 + 1} \right) + C$
		\item $\dint \arctg x dx = x \arctg x - \dint x d (\arctg x) = x \arctg x - \dfrac{1}{2} \dint \dfrac{2}{x^2 + 1} dx = x \arctg x - \dfrac{1}{2} \ln (x^2 + 1) + C$
	\end{enumerate}
