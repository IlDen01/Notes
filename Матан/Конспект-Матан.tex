...
\begin{document}
	...
	\begin{theorem}[Формула замены переменной]
		Пусть $f$ непрерывна на $[\alpha, \beta]$; $g$ непрерывно дифференцируема на $[a, b]$ и $g(a) = \alpha$, $g(b) = \beta$. Тогда $\dint\limits_a^b f(g(x)) g'(x) dx = \dint\limits_a^b f(t) dt$.
	\end{theorem}
