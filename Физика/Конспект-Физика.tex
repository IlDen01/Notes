...
\begin{document}
	...
	\begin{definition}[Емкость конденсатора, $c \, \text{Ф}$]
		$c = \dfrac{q}{U} = \dfrac{\varepsilon \varepsilon_0 S}{d}$.
	\end{definition}
	...
	\begin{itemize}
		\item $\dfrac{1}{c_{\text{об}}} = \dfrac{1}{c_1} + \dfrac{1}{c_2} + \dots$
		\item $q_{\text{об}} = q_1 = q_2 = \dots$
		\item $U_{\text{об}} = U_1 + U_2 + \dots$
	\end{itemize}
	
	\subsubsection{Параллельное соединение.}
	
	\begin{itemize}
		\item $c_{\text{об}} = c_1 + c_2 + \dots$
		\item $q_{\text{об}} = q_1 + q_2 + \dots$
		\item $U_{\text{об}} = U_1 = U_2 = \dots$
	\end{itemize}
\end{document}
