...
\begin{document}
	...
	\begin{definition}[Заряд]
		$q$, $[q] = \, \text{Кл}$. Отрицательно заряженное тело~--- избыток электронов, положительно~--- недостаток. Заряд электрона: $-1.6 \cdot 10^{-19} \, \text{Кл}$; протона аналогичный, но с плюсом.
	\end{definition}
	...
	\paragraph{Закон Кулона.} Кулон открыл, что $F \sim q_1$, $F \sim q_2$, $F \sim \dfrac{1}{r^2}$. Позднее была получена формула:
	$$
