...
\begin{document}
	...
	$\omega_0^2 = \dfrac{k}{m}$~--- циклическая частота.
	...
	Так как $mg = k|\varDelta l|$, получаем $-kx = ma_x$, где $x = \varDelta x$.
	...
	$\sin\alpha \approx \alpha$ (при малых углах) $\Rightarrow -g\alpha = a_{\tau}$.
