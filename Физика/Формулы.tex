...
\begin{document}
	...
	\textbf{Уравнение Менделеева-Клапейрона.} $pV = \nu RT$, $R = 8.314 \dfrac{\text{Дж}}{\text{моль} \cdot \text{К}}$.\\
	...
	\textbf{Внутренняя энергия газа.} $U = \dfrac{i}{2} \nu R T$.\\
	\textbf{Работа газа.} $A = p \varDelta V$.\\
	\textbf{Первое начало термодинамики.} $Q = A_{\text{тела}} + \varDelta U$.\\
	\textbf{Теплоемкости.}
	\begin{enumerate}
		\item $c = \dfrac{Q}{m \varDelta T}$.
		\item Изохорный процесс.\\
		$c = \dfrac{\frac{i}{2} R}{M}$.\\
		$c_{M_V} = c \cdot M = \dfrac{iR}{2}.$
		\item Изобарный процесс.\\
		$c = \left( \dfrac{i}{2} + 1 \right) \dfrac{R}{M}$.\\
		...
		$c = 0$.
	\end{enumerate}
	\textbf{Коэффициент Пуассона.} $\gamma = \dfrac{c_{M_p}}{c_{M_V}} = \dfrac{i + 2}{i}$.\\
	\textbf{Константные соотношения.}
	\begin{enumerate}
		\item $pV^\gamma = const$.
		\item $Tp^{\frac{1 - \gamma}{\gamma}} = const$.
		\item $TV^{\gamma - 1} = const$.
	\end{enumerate}
	\textbf{КПД.} $\eta = \dfrac{A}{Q_{\text{н}}} = \dfrac{Q_{\text{н}} - Q_{\text{х}}}{Q_{\text{н}}} = 1 - \dfrac{Q_{\text{х}}}{Q_{\text{н}}}$.\\
	\textbf{Теорема Карно.} $\eta = \dfrac{T_1 - T_2}{T_1}$.\\
	\textbf{Холодильный коэффициент.} $\xi = \dfrac{Q_{\text{х}}}{A} = \dfrac{T_2}{T_1 - T_2}$.\\
	\textbf{Коэффициент поверхностного натяжения.} $\sigma = \dfrac{W_{\text{пов}}}{S}$, $\dfrac{\text{Дж}}{\text{м}^2}$.\\
	\textbf{Сила поверхностного натяжения.} $F = \sigma P$.\\
	\textbf{Формула Жюрена} (определяет высоту, на которую поднимается жидкость в капилляре). $h = \dfrac{2 \sigma}{\rho g r}$.\\
	\textbf{Избыточное давление Лапласа под искривленной поверхностью.} $p = \dfrac{2 \sigma}{r}$.\\
	\textbf{Закон линейного теплового расширения.} $l = l_0 (1 + \alpha \varDelta t)$, $[\alpha] = \dfrac{1}{\text{\textdegree} C}$.\\
	\textbf{Механическое напряжение.} $\sigma = \frac{F}{S} = \varepsilon \cdot \frac{kl_0}{S} = E \cdot |\varepsilon|$. $[\sigma] = \frac{\text{Н}}{\text{м}^2} = \text{Па}$.\\
	\textbf{Относительная деформация.} $|\varepsilon| = \dfrac{|\varDelta l|}{l_0}$.\\
	\textbf{Модуль Юнга.} $E = \frac{kl_0}{S}$. $[E] =$ Па.\\
	\textbf{Закон Кулона.} $F = \dfrac{k |q_1| |q_2|}{\varepsilon r^2}, \, k = 9 \cdot 10^9 \, \dfrac{\text{Н} \cdot \text{м}^2}{\text{Кл}^2}$.\\
	\textbf{Напряженность, $E \, \dfrac{\text{В}}{\text{м}}$.} $\vec{E} = \dfrac{\vec{F}}{q_0}$. Для точечного заряда напряженность равна $\dfrac{kQ}{\varepsilon r^2}$.\\
	\textbf{Поток вектора напряженности электрического поля, $\Phi_{E} \, \text{В} \cdot \text{м}$.} $\varDelta \Phi_{E} = E \cdot \varDelta S \cdot \cos \theta$, где $\theta$~--- угол между $\vec{E}$ и $\vec{n}$.\\
	\textbf{Телесный угол, $\Omega \, \text{стерадианы (ср)}$.} $\Omega = \dfrac{S}{R^2}$.\\
	\textbf{Поверхностная плотность заряда, $\sigma \, \dfrac{\text{Кл}}{\text{м}}$.} $\sigma = \dfrac{q}{S}$.\\
	\textbf{Напряженность электрического поля бесконечной равномерно заряженной плоскости.} $E = 2 \pi k \sigma = \dfrac{\sigma}{2 \varepsilon_0}$.\\
	\textbf{Работа, $A \, \text{Дж}$.} $A = F l \cos \alpha = q E l \cos \alpha$.\\
	\textbf{Потенциал, $\varphi \, \text{В}$.} $\varphi = \dfrac{W}{q}$.\\
	\textbf{Связь между напряженностью однородного электрического поля и разностью потенциалов (напряжением).} $\underbrace{\varphi_1 - \varphi_2}_U = El$.\\
	\textbf{Потенциал электрического поля точечного заряда.} $\varphi = \dfrac{kQ}{r}$.\\
	\textbf{Энергия взаимодействия, $W \, \text{Дж}$.} $W = \dfrac{kQq}{r}$.\\
	\textbf{Емкость конденсатора, $c \, \text{Ф}$.} $c = \dfrac{q}{U} = \dfrac{\varepsilon \varepsilon_0 S}{d}$; $\varepsilon_0 = \dfrac{1}{4 \pi k} = 8.85 \cdot 10^{-12} \dfrac{\text{Кл}^2}{\text{Н} \cdot \text{м}^2}$.\\
	\textbf{Энергия конденсатора.} $W = \dfrac{c U^2}{2}$.\\
	\textbf{Последовательное соединение.}
	$$
	...
	U_{\text{об}} = U_1 = U_2 = \dots
	$$
	\textbf{Проводимость.} $G = \dfrac{I}{U}$; $[G] =$ См.\\
	\textbf{Электро-химический эквивалент} $k = \dfrac{M}{N_a e z}$, $[k] = \dfrac{\text{кг}}{\text{Кл}}$.\\
	\textbf{Электролиза Фарадея} $m = k I \varDelta t$.
\end{document}
